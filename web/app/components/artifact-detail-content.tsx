...
import { FORM_EMOJI, QUALITY_BADGE, QUALITY_EMOJI, INSCRIPTION_STYLES, INSCRIPTION_EMOJI, AGE_STYLES, MATERIAL_STYLES, SITE_STYLES } from "../lib/artifact-styles";

interface ArtifactDetailContentProps {
  nft: Nft;
}

// Trait rows + chain/explorer footer, shared between NftDetailModal (a
// click-through quick view) and the auction room's always-visible
// ArtifactPanel, so the two stay in sync instead of duplicating field logic.
export function ArtifactDetailContent({ nft }: ArtifactDetailContentProps) {
